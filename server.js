...
━━━━━━━━━━━━━━━━\n`;
        ...
        last15.forEach(r=>{
            ...
            reply+=`🔹 Sill ${sill} | ${quality} | ${lot.toLocaleString()} yds\n`;
        });
...
let party=g[3]||"";
let partyWord = clean(q.replace(sectionKey,""));
...
lines.push(`🔹 ${d.date} | Sill ${d.sill} | Lot ${d.lot.toLocaleString()} | ${d.val.toLocaleString()} yds`);
total+=d.val;
});
